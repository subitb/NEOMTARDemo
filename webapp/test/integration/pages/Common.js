sap.ui.define([
		...
		function getFrameUrl (sHash, sUrlParameters) {
			var sUrl = jQuery.sap.getResourcePath("com/mycompany/northwind/app", ".html");
			sHash = sHash || "";
		...
		return Opa5.extend("com.mycompany.northwind.test.integration.pages.Common", {
			...
			getMockServer : function () {
				return new Promise(function (success) {
					Opa5.getWindow().sap.ui.require(["com/mycompany/northwind/localService/mockserver"], function (mockserver) {
